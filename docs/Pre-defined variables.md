...
This list also includes the "special variables," which have different behavior when accessed and/or assigned.
Many of these are golfing-specifc.
(For regex match variables, see [Regex operations](https://github.com/dloscutoff/pip/blob/master/Documentation/Regex%20operations.md).) Eventually, every letter h-z should appear below.
...
`a` Special variable: reads all command line arguments given in as a list

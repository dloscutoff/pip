...
precedenceTable = [
    ...
    [2,
     ("CB", "COMBINATIONS", "L", [], RVALS | IN_LAMBDA),
     ],
    [1,
     ...
     ("PM", "PERMUTATIONS", "L", None, RVALS | IN_LAMBDA),
     ],
    [2,
    ...
    [2,
     ...
     ("JW", "JOINWRAP", "L", None, RVALS | IN_LAMBDA),
    ...
    [1,
     ...
     ("CG", "COORDINATEGRID", "L", None,
      RVALS | IN_LAMBDA | LIST_EACH | RANGE_EACH),
     ("ZG", "ZEROGRID", "L", None, RVALS | IN_LAMBDA | LIST_EACH | RANGE_EACH),
     ("EY", "IDENTITYMATRIX", "L", None,
      RVALS | IN_LAMBDA | LIST_EACH | RANGE_EACH),
     ],
    [3,
     ("R", "REPLACE", "L", None, RVALS),
     ],
    [2,
     ("WR", "WRAP", "L", "", RVALS | IN_LAMBDA),
     ],
    [2,
     (".", "CAT", "L", "", RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ],
    [1,
     (".", "DOT", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
     ("K", "KLEENESTAR", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
     ],
    [2,
    ...
    [1,
     ("||", "STRIP", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
     ("|>", "LSTRIP", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
     ("<|", "RSTRIP", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
     ("TM", "TRIM", "L", None, RVALS | IN_LAMBDA | LIST_EACH),
    ...
    [2,
     ...
     ("AT", "ARCTAN", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("CM", "NUMCMP", "L", 0, RVALS | IN_LAMBDA),
     ],
    [1,
    ...
    [1,
     ...
     ("-", "NEG", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("/", "INVERT", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ],
    [2,
    ...
    [1,
     ...
     ("SI", "SINE", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("CO", "COSINE", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("TA", "TANGENT", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("SE", "SECANT", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("CS", "COSEC", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("CT", "COTAN", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("AT", "ARCTAN", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("RD", "RADIANS", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ("DG", "DEGREES", "L", None, RVALS | IN_LAMBDA | RANGE_EACH | LIST_EACH),
     ],
    [2,

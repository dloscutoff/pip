...
precedenceTable = [
    ...
    [1, None,
     ...
     ("FX", "FILTERINDEXES", None, RVALS),
     ("FJ", "FILTERJOIN", None, RVALS),
     ("FF", "FILTERFLATTEN", None, RVALS),
     ("FQ", "FILTERUNIQUE", None, RVALS),
    ...
    [2, "R",
     ...
     ("FI", "FILTER", [], RVALS),
     ("FN", "FILTERNOT", [], RVALS),
     ("FE", "FILTERENUMERATE", [], RVALS),
     ("FU", "FILTERUNPACK", [], RVALS),
     ("FX", "FILTERINDEXES", [], RVALS),
     ("FJ", "FILTERJOIN", [], RVALS),
     ("FF", "FILTERFLATTEN", [], RVALS),
     ("FQ", "FILTERUNIQUE", [], RVALS),
     ("SK", "SORTKEYED", [], RVALS),
    ...
    [1, None,
     ...
     ("FL", "FLATTEN", None, RVALS | IN_LAMBDA),
     ("FA", "FLATTENALL", None, RVALS | IN_LAMBDA),
     ],
    [2, "L",
    ...
    [1, None,
     ...
     ("ZJ", "ZIPJOIN", None, RVALS | IN_LAMBDA),
    ...
    [2, "L",
     ...
     ("|<", "FLOOR", 0, RVALS | IN_LAMBDA | RANGE_EACH),
     (">|", "CEIL", 0, RVALS | IN_LAMBDA | RANGE_EACH),
     ("RZ", "ROUNDZERO", 0, RVALS | IN_LAMBDA | RANGE_EACH),
     ("RN", "ROUNDNEAREST", 0, RVALS | IN_LAMBDA | RANGE_EACH),
     ],
    [1, None,
     ...
     ("|<", "FLOOR", None, RVALS | IN_LAMBDA | RANGE_EACH),
     (">|", "CEIL", None, RVALS | IN_LAMBDA | RANGE_EACH),
     ("RZ", "ROUNDZERO", None, RVALS | IN_LAMBDA | RANGE_EACH),
     ("RN", "ROUNDNEAREST", None, RVALS | IN_LAMBDA | RANGE_EACH),
     ],
    [2, "L",
